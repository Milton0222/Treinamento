...
tarefas.estado,tarefas.data_inicio,tarefas.data_conclusao,tarefas.id_projeto
          ...
          <div class="conteudo">
               ...
               <div class="graficos1">
                    ...
                    <form action="" method="get" class="form">
                     ...
                     <a href="tarefaCriar.php"><strong>+</strong></a>
                         <div class="gsearch">
  ...
  <div class='modal-dialog'>
    <div class='modal-content'>
      <div class='modal-header'>
        <h5 class='modal-title' id='exampleModalLabel'>Desejas  apagar a tarefa $nome ?</h5>
